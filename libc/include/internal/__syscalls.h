...
#define __HOJICHA_SYS_SYSCALL_BRK       0xC
#define __HOJICHA_SYS_SYSCALL_IOCTL     0x10
#define __HOJICHA_SYS_SYSCALL_NANOSLEEP 0x23
#define __HOJICHA_SYS_SYSCALL_FORK      0x39
#define __HOJICHA_SYS_SYSCALL_EXECVE    0x3B
